...
class GUI:
    ...
    # ---------- SECTION 1 ----------
    def build_section1(self, parent):
        ...
        tk.Entry(frame, textvariable=self.weight1,
                 font=("Arial", 14), width=5).grid(row=1, column=1)
        ...
        tk.Entry(frame, textvariable=self.numWires1,
                 font=("Arial", 14), width=5).grid(row=2, column=1)
        ...
        ttk.Button(frame, text="Calculate", command=self.calculate1).grid(
            row=7, column=0, pady=10)

    # ---------- SECTION 2 ----------
    def build_section2(self, parent):
        frame = tk.Frame(parent, bg=self.BG_COLOR)
        frame.pack(padx=20, pady=20, anchor="w")
        ...
        tk.Entry(frame, textvariable=self.numWires2,
                 font=("Arial", 14), width=5).grid(row=3, column=1)
        ...
        ttk.Button(frame, text="Calculate", command=self.calculate2).grid(
